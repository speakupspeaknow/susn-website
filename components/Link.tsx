  ...
  (props: LinkStyleProps) =>
    props.buttonStyle || props.buttonSize
      ? {
          ...
          ...(props.buttonStyle ? buttonlikeStyles.styleVariants[props.buttonStyle] : {}),
          ...(props.buttonSize ? buttonlikeStyles.sizeVariants[props.buttonSize] : {}),
          textDecoration: "none",
        }
...
interface InternalLinkProps extends React.ComponentProps<typeof NextLink>, LinkStyleProps {}
...
const isExternalLink = (url: string) => {
  return typeof url === "string" && (url.startsWith("http") || url.startsWith("mailto"));
};
