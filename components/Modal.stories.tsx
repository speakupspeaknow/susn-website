    ...
    <Box position="relative" zIndex={0}>
      ...
      >
        <Box>
          ...
          <Text.Body>
            This is the most basic use case of a modal. No buttons, confirmation dialogs, or any
            other frills.
          </Text.Body>
        </Box>
      </Modal>
    ...
    <Box position="relative" zIndex={0}>
      ...
      >
        <Box>
          ...
          <Text.Body mb={3}>
            This is a modal that prompts the user for a confirmation if they try to close it without
            saving their changes. For a demo, edit the input field below and press the exit 'X'
            without saving.
          </Text.Body>
